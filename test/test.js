...
require("tape")("point-in-simplex", function(t) {
  ...
  function test(triangle) {
    ...
    t.equals(pointInSimplex(triangle, [0, 10]), -1)
    t.equals(pointInSimplex(triangle, [0, -10]), -1)
    t.equals(pointInSimplex(triangle, [-10, 0]), -1)
    t.equals(pointInSimplex(triangle, [10, 0]), -1)
  ...
  var tet = [[0,0,0], [1,0,0], [0,1,0], [0,0,1]]

  t.equals(pointInSimplex(tet, [0.25, 0.25, 0.25]), 1)
  t.equals(pointInSimplex(tet, [0.5, 0.5, 0.5]), -1)
  t.equals(pointInSimplex(tet, [1, 1, 1]), -1)
